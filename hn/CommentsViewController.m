                ...
                if([responseDictionary isKindOfClass:[NSDictionary class]]){
                    if([responseDictionary objectForKey:@"id"] != nil){
                        ...
                        if([self.commentDescriptions objectForKey:key]){
                            ...
                            //                            [self.tableView reloadRowsAtIndexPaths:@[[NSIndexPath indexPathForItem:index inSection:1]] withRowAnimation:UITableViewRowAnimationNone];
                            ...
                            [self.commentDescriptions setObject:[responseDictionary copy] forKey:key];
                            //                            [self.tableView beginUpdates];
                            //                            [self.tableView insertRowsAtIndexPaths:@[[NSIndexPath indexPathForItem:index inSection:1]] withRowAnimation:UITableViewRowAnimationNone];
                            //                            [self.tableView endUpdates];
                            [self.tableView reloadData];
                        }
...
- (HNTableViewCell *)configureStoryCellAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HNTableViewCell *cell = (HNTableViewCell *)[self.tableView dequeueReusableCellWithIdentifier:@"HNCell" forIndexPath:indexPath];
